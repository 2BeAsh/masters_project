...
from workforce_master import Workforce, number_of_companies, number_of_workers, interest_rate_change_size, salary_factor, time_steps
...
bank_wellmixed = BankWellMixed(number_of_companies, number_of_workers, interest_rate_change_size, salary_factor, time_steps)
